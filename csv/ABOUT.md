...
Столбцы, которые в прошлом показывали здоровье игроков и NPC (роботов)
...
Уровни то ли боя с боссом, то ли разгрома Суперсити, вообще непонятно... Содержит параметры 7 боссов, за каждого выдаётся награда в 10 кристаллов
