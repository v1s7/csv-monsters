...
![1. Очистите данные игры. Не бойтесь, сами данные не очистятся. 2. В открывшемся меню выберите "Управление модификациями".](https://github.com/v1s7/csv-monsters/raw/refs/heads/media/manage-mods-settings-method-24fps.avifs)
