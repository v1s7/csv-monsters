[[FAQ]] <sup><sub>by MRSFOLLS</sub></sup>
## Назначение папок
...
6. "📎" > "Файл" > "Внутреннее хранилище", и находите ранее скачанный скрипт. Могут произойти несколько случаев:
	1. Если файл отправится сразу, без возможности дописать сообщение, и вас просят приложить json-файл:
	...
	3. Если файл был "успешно подписан", то смело скачивайте его, открываете и в меню выбираете Null's Brawl. Подробнее об установке читать в [[FAQ]]. 